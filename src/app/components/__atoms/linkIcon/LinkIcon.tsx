import { LinkIconPropsType } from "@/app/interfaces/interface";

const LinkIcon = ({ isActive }: LinkIconPropsType) => {
  return (
    <div className="group">
      <svg
        ...
        fill="none"
        viewBox="0 0 21 20"
        className="transition duration-300 ease-in-out group-hover:fill-[#633CFF]"
      >
        <path
